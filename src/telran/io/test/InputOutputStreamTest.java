...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // to ensure the order in which tests are taken
class InputOutputStreamTest {
	...
	void outputStreamTest() throws Exception {
		try (OutputStream output = new FileOutputStream(fileName)) {// create, if there is second arg true = avail overwriting
